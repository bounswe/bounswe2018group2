    ...
    return (
      <Pane background="tint1">
        <Pane background="#DDEBF7" padding={16} >
          <Button iconBefore="home" height={30} marginRight={16} appearance="minimal" intent="default" >
            Home Page
        </Button>
          <Button iconBefore="envelope" height={30} marginRight={16} appearance="minimal" intent="default" >
            Messages
        </Button>
          <Button iconBefore="mugshot" height={30} marginRight={16} appearance="minimal" intent="default">
            My Profile
        </Button>
          <Button iconBefore="log-out" height={30} marginRight={16} appearance="minimal" intent="default" >
            Log-out
        </Button>
        </Pane>
          ...
          <Pane padding={16} background="tint1" display="vertical">
            ...
            >
              ...
              <Table.Body height={240}>
                ...
                <Table.Row
                  intent='warning'>
                  <Table.TextCell>Jack Philips</Table.TextCell>
                  <Table.TextCell>6 minutes ago</Table.TextCell>
                ...
                <Table.Row
                  intent='danger'>
                  <Table.TextCell>Julia Williamson</Table.TextCell>
                  <Table.TextCell>10 minutes ago</Table.TextCell>
                  <Table.TextCell isNumber>
                    $242
  </Table.TextCell>
                </Table.Row>
                ...
                <Table.Row
                  intent='success'>
                  <Table.TextCell>Jonathan Martin</Table.TextCell>
                  <Table.TextCell>6 minutes ago</Table.TextCell>
                  <Table.TextCell isNumber>
                    $242
  </Table.TextCell>
                ...
                <Table.Row
                  intent='none'>
                  <Table.TextCell>Maria Bennett</Table.TextCell>
                  <Table.TextCell>6 minutes ago</Table.TextCell>
                  <Table.TextCell isNumber>
                    $242
                    </Table.TextCell>
